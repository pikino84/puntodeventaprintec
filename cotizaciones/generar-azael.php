...
$ssql = " 
                                ...
                                THEN '/img/servicio-especial/servicio-especial.jpg'
                                ELSE 
                                CONCAT('/img/servicio-especial/',p.Imagen)
                                END
                                AS Imagen
...
<table width='100%'>
<tr>
<td width='40%'><img src='/img/".$logo."' width='200px'/></td>
<td>
...
<table width='100%'>
<tr>
<td width='235' align='left' style='border-right:2px solid #cf8151' ><img src='http://cdnprintec.yoynetworking.com/backend/printec/".$logo."' width='200px'/></td>
...
//$mail->Password="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";        // SMTP account password
