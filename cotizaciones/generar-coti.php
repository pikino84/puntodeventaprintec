...
$ssql = " 
                                ...
                                THEN 'https://backend.toursyaventura.com/backend/printec/servicio-especial/servicio-especial.jpg'
                                ELSE 
                                CONCAT('https://backend.toursyaventura.com/backend/printec/servicio-especial/',p.Imagen)
                                END
                                AS Imagen
...
<table width='100%'>
<tr>
<td width='40%'><img src='https://backend.toursyaventura.com/backend/printec/".$logo."' width='200px'/></td>
<td>
