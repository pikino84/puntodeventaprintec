...
?>
			    ...
			    <div class="page-header">
			    	<div class="page-title">
				    	<h5>Listado de Cotizaciones Autorizadas</h5>				    	
			    	</div>			    	
			    </div>
			    <!-- /page header -->
                ...
                <div class="widget">    
                    ...
                    <ul class="toolbar">
                        ...
                        <li><a href="/cotizaciones/pendientes.php" title=""><i class="ico-search"></i><span>Cot. Pendientes</span></a></li>
                    </ul>              	
...
while($dt=$resultado->fetch_assoc()){
                                ...
                                <tr id="reg-<?=$dt['folio']?>"> 
                                    ...
                                    <?php if($dt['cerrado']==1){ ?>
                                    <td><a href="abrir_cotizacion.php?id=<?=$dt['folio']?>&evt=U" class="accionDel">Abrir</a></td>   
                                    <?php }else{?>
                                    <td>&nbsp;</td>
                                    <?php } ?>
